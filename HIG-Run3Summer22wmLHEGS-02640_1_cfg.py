...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-Run3Summer22wmLHEGS-02640.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-Run3Summer22wmLHEGS-02640_inLHE.root'),
...
process.vbfGenJetFilterD = cms.EDFilter("VBFGenJetFilter",
    ...
    minLeadingJetsInvMass = cms.untracked.double(300.0),
