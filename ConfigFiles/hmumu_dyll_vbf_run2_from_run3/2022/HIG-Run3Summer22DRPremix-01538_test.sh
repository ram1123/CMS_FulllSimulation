...
# cmsDriver command
cmsDriver.py  --era Run2_2017 --customise Configuration/DataProcessing/Utils.addMonitoring --procModifiers siPixelQualityRawToDigi --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --conditions 106X_mc2017_realistic_v6 --datatier AODSIM --eventcontent AODSIM --python_filename HIG-Run3Summer22DRPremix-01538_2_cfg.py --fileout file:HIG-Run3Summer22DRPremix-01538.root --filein file:HIG-Run3Summer22DRPremix-01538_0.root --number 100 --number_out 100 --no_exec --mc || exit $? ;
