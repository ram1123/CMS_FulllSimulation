...
# Dump actual test code to a HIG-RunIISummer20UL17SIM-03331_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > HIG-RunIISummer20UL17SIM-03331_test.sh
#!/bin/bash
...
# End of HIG-RunIISummer20UL17SIM-03331_test.sh file
EndOfTestFile

# Make file executable
chmod +x HIG-RunIISummer20UL17SIM-03331_test.sh
...
singularity run -B /afs -B /cvmfs -B /etc/grid-security -B /etc/pki/ca-trust --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/HIG-RunIISummer20UL17SIM-03331_test.sh)
