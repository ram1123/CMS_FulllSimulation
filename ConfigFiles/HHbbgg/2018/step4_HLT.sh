...
#cd /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/HIG-RunIISummer20UL18HLT-03374/
...
# Dump actual test code to a HIG-RunIISummer20UL18HLT-03374_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > HIG-RunIISummer20UL18HLT-03374_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --python_filename HIG-RunIISummer20UL18HLT-03374_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:HIG-RunIISummer20UL18HLT-03374.root --conditions 102X_upgrade2018_realistic_v15 --customise_commands 'process.source.bypassVersionCheck = cms.untracked.bool(True)' --step HLT:2018v32 --geometry DB:Extended --filein file:HIG-RunIISummer20UL18DIGIPremix-03355.root --era Run2_2018 --no_exec --mc -n $EVENTS || exit $? ;

# End of HIG-RunIISummer20UL18HLT-03374_test.sh file
EndOfTestFile

# Make file executable
chmod +x HIG-RunIISummer20UL18HLT-03374_test.sh
...
singularity run -B /afs -B /cvmfs -B /etc/grid-security -B /etc/pki/ca-trust --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/HIG-RunIISummer20UL18HLT-03374_test.sh)
