...
#cd /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/SMP-RunIISummer20UL17DIGIPremix-00109/
...
# Dump actual test code to a SMP-RunIISummer20UL17DIGIPremix-00109_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > SMP-RunIISummer20UL17DIGIPremix-00109_test.sh
#!/bin/bash
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/SMP-RunIISummer20UL17DIGIPremix-00109_test.sh)
