...
# with command line options: Configuration/GenProduction/python/B2G-RunIISummer20UL17wmLHEGEN-07106-fragment.py --era Run2_2017 --customise Configuration/DataProcessing/Utils.addMonitoring --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN --geometry DB:Extended --conditions 106X_mc2017_realistic_v6 --datatier GEN,LHE --eventcontent RAWSIM,LHE --python_filename B2G-RunIISummer20UL17wmLHEGEN-07106_1_cfg.py --fileout file:B2G-RunIISummer20UL17wmLHEGEN-07106.root --number 333 --number_out 333 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/B2G-RunIISummer20UL17wmLHEGEN-07106-fragment.py nevts:'+str(options.maxEvents)),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:B2G-RunIISummer20UL17wmLHEGEN-07106.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:B2G-RunIISummer20UL17wmLHEGEN-07106_inLHE.root'),
